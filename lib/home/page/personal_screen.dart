                        ...
                        children: <Widget>[
                          RichText(
                            text: TextSpan(children: [
                              ...
                              TextSpan(
                                  text: " Ngoại ngữ:", style: boldTextStyle)
                            ]),
                          ),
//                        Wrap(
//                          crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        children: <Widget>[
                          RichText(
                            text: TextSpan(children: [
                              ...
                              TextSpan(
                                  text: " Kĩ năng khác:", style: boldTextStyle)
                            ]),
                          ),
                          Padding(
                            ...
                            child: Wrap(
                              ...
                              children: resume.otherSkills
                                  .map((string) => Chip(label: Text(string)))
                                  .toList(),
                            ),
                          )
                        ],
